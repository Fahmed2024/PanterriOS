...
// --- Icons ---
import { BoldIcon } from "@/components/tiptapEditor/tiptap-icons/bold-icon"
import { Code2Icon } from "@/components/tiptapEditor/tiptap-icons/code2-icon"
import { ItalicIcon } from "@/components/tiptapEditor/tiptap-icons/italic-icon"
import { StrikeIcon } from "@/components/tiptapEditor/tiptap-icons/strike-icon"
import { SubscriptIcon } from "@/components/tiptapEditor/tiptap-icons/subscript-icon"
import { SuperscriptIcon } from "@/components/tiptapEditor/tiptap-icons/superscript-icon"
import { UnderlineIcon } from "@/components/tiptapEditor/tiptap-icons/underline-icon"
